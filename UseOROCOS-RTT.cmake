...
if(OROCOS-RTT_FOUND AND NOT USE_OROCOS_RTT)
  ...
  if (CMAKE_COMPILER_IS_GNUCXX AND NOT APPLE AND NOT VXWORKS)
    SET(USE_OROCOS_LDFLAGS_OTHER "-Wl,-z,defs")
  else (CMAKE_COMPILER_IS_GNUCXX AND NOT APPLE AND NOT VXWORKS)
    SET(USE_OROCOS_LDFLAGS_OTHER " ")
  endif (CMAKE_COMPILER_IS_GNUCXX AND NOT APPLE AND NOT VXWORKS)
  ...
  macro( orocos_component COMPONENT_NAME )
    ...
    # Set library name:
    if ( ${OROCOS_TARGET} STREQUAL "gnulinux" OR ${OROCOS_TARGET} STREQUAL "lxrt" OR ${OROCOS_TARGET} STREQUAL "xenomai" OR ${OROCOS_TARGET} STREQUAL "win32" OR ${OROCOS_TARGET} STREQUAL "macosx" OR ${OROCOS_TARGET} STREQUAL "vxworks")
